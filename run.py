#!/usr/bin/env python3
"""Run ONE problem of winogrande through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one winogrande problem via TrustedRouter")
