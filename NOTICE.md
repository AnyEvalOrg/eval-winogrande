...
`eval-winogrande` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/winogrande`)
...
- `huggingface`: `allenai/winogrande`
